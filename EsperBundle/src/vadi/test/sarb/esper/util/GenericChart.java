...
public class GenericChart {
	...
	public void setOrientation(String str) {
		...
		public GenericChart() throws HeadlessException {
		super();
	...
	public synchronized void addData(String xy,Double val )
	{
		...
		num++;
		seriesCount.put(xy,num);
		this.addData(xy, (double)num, val);
	//	series.get(xy).add((double)num, val);
		
		//series.get(xy).a
	}
	
	public synchronized void addData(Double val ){
		if (series.isEmpty() )
			throw new RuntimeException("Chart has no series data");
		String str = series.keys().nextElement();
		this.addData(str, val);
